...
{block name="body"}
  <div xmlns:v="http://rdf.data-vocabulary.org/#" typeof="v:Review-aggregate"> 
	...
	<a rel="prev" href="article.php?id={$prev_button.id}" title="{$prev_button.title|strip_tags|escape}">
	...
	<a rel="next" href="article.php?id={$next_button.id}" title="{$next_button.title|strip_tags|escape}">
