...
[![](/img/victimpics/gamewillsuck.png)](@/victim/226.md)**I HAVEN'T
...
{% css_class(class="left clear") %}
[![](/img/victimpics/smooth.png)](@/victim/220.md)**THIS GAME IS
...
{% css_class(class="left clear") %}
[![](/img/victimpics/german.png)](@/victim/216.md)**THERE AREN'T
ENOUGH NAZIS!**
{% end %}
